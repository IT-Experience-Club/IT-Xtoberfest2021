...
getPrice(factory="Twindex",pair="TWIN/BUSD")
# getPrice(factory="Pancake",pair="TWIN/BUSD")
getPrice(factory="Twindex",pair="TWIN/DOP")
# getPrice(factory="Pancake",pair="TWIN/DOP")
getPrice(factory="Twindex",pair="dAPPL/DOP")
getPrice(factory="Twindex",pair="dTSLA/DOP")
getPrice(factory="Twindex",pair="dAMZN/DOP")
getPrice(factory="Twindex",pair="dGOOGL/DOP")

getPrice(factory="Pancake",pair="SCZ/BUSD")
getPrice(factory="Pancake",pair="ZFARM/BUSD")